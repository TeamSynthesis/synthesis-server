...
namespace synthesis.api.Migrations
{
    ...
    [Migration("20240410212230_init_update")]
            ...
            modelBuilder.Entity("synthesis.api.Data.Models.PrePlanModel", b =>
                {
                    ...
                    b.OwnsOne("synthesis.api.Services.OpenAi.Dtos.GeneratedPrePlanDto", "Plan", b1 =>
                        {
                            b1.Property<Guid>("PrePlanModelId")
                                .HasColumnType("uuid");

                            b1.HasKey("PrePlanModelId");
                            ...
                            b1.WithOwner()
                                .HasForeignKey("PrePlanModelId");

                            b1.OwnsOne("synthesis.api.Data.Models.Branding", "Branding", b2 =>
                                {
                                    b2.Property<Guid>("GeneratedPrePlanDtoPrePlanModelId")
                                        .HasColumnType("uuid");

                                    b2.Property<string>("Slogan")
                                        .HasColumnType("text");

                                    b2.HasKey("GeneratedPrePlanDtoPrePlanModelId");

                                    b2.ToTable("PrePlans");

                                    b2.WithOwner()
                                        .HasForeignKey("GeneratedPrePlanDtoPrePlanModelId");

                                    b2.OwnsOne("synthesis.api.Data.Models.Image", "Icon", b3 =>
                                        {
                                            b3.Property<Guid>("BrandingGeneratedPrePlanDtoPrePlanModelId")
                                                .HasColumnType("uuid");
                                            ...
                                            b3.HasKey("BrandingGeneratedPrePlanDtoPrePlanModelId");

                                            b3.ToTable("PrePlans");

                                            b3.WithOwner()
                                                .HasForeignKey("BrandingGeneratedPrePlanDtoPrePlanModelId");
                                        });
                                    ...
                                    b2.OwnsOne("synthesis.api.Data.Models.Wireframe", "Wireframe", b3 =>
                                        {
                                            ...
                                            b3.OwnsOne("synthesis.api.Data.Models.Image", "Image", b4 =>
                                                {
                                                    b4.Property<Guid>("WireframeBrandingGeneratedPrePlanDtoPrePlanModelId")
                                                        .HasColumnType("uuid");
                                                    ...
                                                    b4.HasKey("WireframeBrandingGeneratedPrePlanDtoPrePlanModelId");

                                                    b4.ToTable("PrePlans");

                                                    b4.WithOwner()
                                                        .HasForeignKey("WireframeBrandingGeneratedPrePlanDtoPrePlanModelId");
                                                });
                            ...
                            b1.OwnsOne("synthesis.api.Data.Models.CompetitiveAnalysis", "CompetitiveAnalysis", b2 =>
                                {
                                    ...
                                    b2.OwnsMany("synthesis.api.Data.Models.Competitor", "Competitors", b3 =>
                                        {
                                            b3.Property<Guid>("CompetitiveAnalysisGeneratedPrePlanDtoPrePlanModelId")
                                                .HasColumnType("uuid");
                                            ...
                                            b3.HasKey("CompetitiveAnalysisGeneratedPrePlanDtoPrePlanModelId", "Id");

                                            b3.ToTable("PrePlans");

                                            b3.WithOwner()
                                                .HasForeignKey("CompetitiveAnalysisGeneratedPrePlanDtoPrePlanModelId");
                                        });
                                    ...
                                    b2.OwnsOne("synthesis.api.Data.Models.Swot", "Swot", b3 =>
                                        {
                                            ...
                                            b3.HasKey("CompetitiveAnalysisGeneratedPrePlanDtoPrePlanModelId");
                                    ...
                                    b2.OwnsOne("synthesis.api.Data.Models.TargetAudience", "TargetAudience", b3 =>
                                        {
                                            ...
                                            b3.OwnsOne("synthesis.api.Data.Models.Demographics", "Demographics", b4 =>
                                                {
                                                    b4.Property<Guid>("TargetAudienceCompetitiveAnalysisGeneratedPrePlanDtoPrePlanModelId")
                                                        .HasColumnType("uuid")
                                                        .HasColumnName("TargetAudienceCompetitiveAnalysisGeneratedPrePlanDtoPrePlanMod~");

                                                    b4.Property<string>("Age")
                                                        .HasColumnType("text");

                                                    b4.HasKey("TargetAudienceCompetitiveAnalysisGeneratedPrePlanDtoPrePlanModelId");

                                                    b4.ToTable("PrePlans");

                                                    b4.WithOwner()
                                                        .HasForeignKey("TargetAudienceCompetitiveAnalysisGeneratedPrePlanDtoPrePlanModelId");
                                                });
                            ...
                            b1.OwnsOne("synthesis.api.Data.Models.Overview", "Overview", b2 =>
                                {
                                    ...
                                    b2.OwnsMany("synthesis.api.Data.Models.SuggestedDomain", "SuggestedDomains", b3 =>
                                        {
                                            b3.Property<Guid>("OverviewGeneratedPrePlanDtoPrePlanModelId")
                                                .HasColumnType("uuid");
                                            ...
                                            b3.HasKey("OverviewGeneratedPrePlanDtoPrePlanModelId", "Id");

                                            b3.ToTable("PrePlans");

                                            b3.WithOwner()
                                                .HasForeignKey("OverviewGeneratedPrePlanDtoPrePlanModelId");
                                        });
                            ...
                            b1.OwnsOne("synthesis.api.Data.Models.Technology", "Technology", b2 =>
                                {
                                    ...
                                    b2.OwnsMany("synthesis.api.Data.Models.TechStack", "TechStacks", b3 =>
                                        {
                                            b3.Property<Guid>("TechnologyGeneratedPrePlanDtoPrePlanModelId")
                                                .HasColumnType("uuid");
                                            ...
                                            b3.HasKey("TechnologyGeneratedPrePlanDtoPrePlanModelId", "Id");

                                            b3.ToTable("PrePlans");

                                            b3.WithOwner()
                                                .HasForeignKey("TechnologyGeneratedPrePlanDtoPrePlanModelId");
                                        });

                                    b2.Navigation("TechStacks");
                                });

                            b1.OwnsMany("synthesis.api.Services.OpenAi.Dtos.GptFeatureDto", "Features", b2 =>
                                {
                                    b2.Property<Guid>("GeneratedPrePlanDtoPrePlanModelId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("GeneratedPrePlanDtoPrePlanModelId", "Id");
                                    ...
                                    b2.OwnsMany("synthesis.api.Services.OpenAi.Dtos.GptTaskDto", "Tasks", b3 =>
                                        {
                                            b3.Property<Guid>("GptFeatureDtoGeneratedPrePlanDtoPrePlanModelId")
                                                .HasColumnType("uuid");

                                            b3.Property<int>("GptFeatureDtoId")
                                                .HasColumnType("integer");
                                            ...
                                            b3.Property<string>("Activity")
                                                .HasColumnType("text");

                                            b3.Property<int>("Priority")
                                                .HasColumnType("integer");

                                            b3.HasKey("GptFeatureDtoGeneratedPrePlanDtoPrePlanModelId", "GptFeatureDtoId", "Id");

                                            b3.ToTable("PrePlans");

                                            b3.WithOwner()
                                                .HasForeignKey("GptFeatureDtoGeneratedPrePlanDtoPrePlanModelId", "GptFeatureDtoId");
                                        });
